...
**💪 Why our Gradient bot is better than alternatives?**
...
* Add proxies in this format: `login:password@ip:port`.
...
* Failed verifications will be saved in `approveEmail_bads.txt`. These accounts can be reattempted, as some might pass on subsequent tries.
